...
var LessonPlans = function(Backbone, $, _, App) {
...
},{"backbone":10,"jquery":11,"lib/bottle":4,"lib/bottleRouter":5,"service/mainRouter":9,"underscore":12}],7:[function(require,module,exports){
...
},{"app":1,"config.json":2,"lib/bottle_ext":6}],8:[function(require,module,exports){
'use strict';

var ControllerDecorator = function(Backbone, App, ViewBuilder) {
    var ObjectCache = {};
        ...
        return {
            ...
            executeAction: function(actionName, params) {
                if (typeof this[actionName] !== 'function') {
                    return new Error('Uknown action: ' + actionName);
                }

                var result = this[actionName].apply(this, params);
            ...
            renderView: function(viewName, data, targetArea) {

            }
        }
    };

    // Using Backbone's extend instead of underscore's
    BaseController.extend = Backbone.View.extend;

    return {
        build: function(name, definition, force) {
            if (ObjectCache[name] && force !== true) {
            ...
            var ChildController = BaseController.extend(definition);
            ObjectCache[name] = ChildController;
...
module.export = ControllerDecorator;
...
},{"controller/lessonPlans.js":3}],10:[function(require,module,exports){
(function (global){
